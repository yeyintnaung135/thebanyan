...
@section('content')
                    ...
                    <div class="portlet box purple ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-gift"></i>Edit Staff </div>
                                    <div class="tools">
                                ...
                                {{ Form::model($user, array('route' => array('staff.update', $user->id), 'method' => 'PUT','class'=> 'form-horizontal', 'role'=>'form'))  }}
                                        <div class="form-body">
                                        ...
                                        <div class="form-actions right1">
                                            <a href="{{ URL::to('/staff') }}" class="btn btn-sm btn-default">Cancle</a>
